...
INSERT INTO employees (first_name, last_name, address, email, salary, dept_id, contact_number, dob, username, password, gender, role, emergency_contact, age)
VALUES ('John', 'Doe', '123 Main St', 'johndoe@example.com', 50000.00, NULL, '123-456-7890', '1985-05-20', 'johndoe', 'hashedpassword', 'Male', 'Manager', '987-654-3210', 39);

SELECT id FROM employees WHERE email = 'johndoe@example.com';

INSERT INTO Department (dept_id, dname, est_date, contact_detail, email, hod_id)
VALUES (1, 'IT Department', '2024-01-01', '1234567890', 'itdept@example.com', 1);
